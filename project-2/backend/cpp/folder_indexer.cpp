 ...
 * Usage: ./folder_indexer <directory> [--depth=5]
...
int main(int argc, char* argv[]) {
    ...
    for (int i = 2; i < argc; ++i) {
        ...
        if (arg.starts_with("--depth=")) max_depth = std::stoi(arg.substr(8));
