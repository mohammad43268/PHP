...
int main(int argc, char *argv[])
{
    ...
    for (int i = 2; i < argc; ++i)
    {
        ...
        // Corrected C++17 fallback for starts_with!
        // 1. Check if it's at least 6 chars long to prevent crashes
        // 2. Check if the first 6 chars are exactly "--max="
